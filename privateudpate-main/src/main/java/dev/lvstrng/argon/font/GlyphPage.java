...
public class GlyphPage {
    ...
    public void generateGlyphPage(char[] chars) {
        ...
        FontRenderContext fontRenderContext =
                new FontRenderContext(affineTransform, antiAliasing, fractionalMetrics);
    ...
    public float drawChar(MatrixStack stack, char ch, float x, float y, float red, float green, float blue, float alpha) {
        ...
        bufferBuilder.vertex(stack.peek().getPositionMatrix(), x, y + height, 0)
                .color(red, green, blue, alpha)
                .texture(pageX, pageY + pageHeight);

        bufferBuilder.vertex(stack.peek().getPositionMatrix(), x + width, y + height, 0)
                .color(red, green, blue, alpha)
                .texture(pageX + pageWidth, pageY + pageHeight);

        bufferBuilder.vertex(stack.peek().getPositionMatrix(), x + width, y, 0)
                .color(red, green, blue, alpha)
                .texture(pageX + pageWidth, pageY);

        bufferBuilder.vertex(stack.peek().getPositionMatrix(), x, y, 0)
                .color(red, green, blue, alpha)
                .texture(pageX, pageY);
