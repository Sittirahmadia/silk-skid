...
public class KeyAnchor extends Module {
    ...
    public KeyAnchor() {
        super("Key Anchor", "Automatically places and explodes respawn anchors for PvP", Category.COMBAT, GLFW.GLFW_KEY_UNKNOWN);
        addSettings(anchorKeybind, delay, restoreDelayTicks);
    }
    ...
    private void onTick(TickEvent event) {
        ...
        else if (!currentKeyState) hasPlacedThisCycle = false;
